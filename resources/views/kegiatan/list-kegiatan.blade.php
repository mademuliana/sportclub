            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <form action="/kegiatan/list-kegiatan/search" method="GET" style="margin-bottom:10px;">
                    ...
                    <a href="/kegiatan/form-input-kegiatan" class="btn btn-sm btn-success">Tambah kegiatan incidental</a>
                </div>
              </div>
            </div>
                ...
                @if($kegiatan->deleted_at == null)
                  ...
                  ?>
                    ...
                    <td>
                      @if($dateFromDb < $today_fmt)
                        @if ($kegiatan->is_approved == 1)
                          <a href="/presensi/form-input-presensi/{{$kegiatan->id}}" class="btn btn-sm btn-primary my-1">Input Absensei</a>
                        @endif  
                      @endif
                      ...
                      @if ($kegiatan->type == 1)
                        <a href="/kegiatan/incedental/{{$kegiatan->id}}" class="btn btn-sm btn-primary my-1">Edit</a>
                      @elseif($kegiatan->type == 2)
                        <a href="/kegiatan/rutin/{{$kegiatan->id}}" class="btn btn-sm btn-primary my-1">Edit</a>
                      @endif       
                              ...
                              <div class="modal-content bg-gradient-default">
                                  ...
                                  <div class="modal-body">  
                                      <div class="py-3 text-center">
                                          ...
                                          <p class="mb-0"></p>{{ $kegiatan->name }}</p>
                                          <p class="mb-0">{{ $kegiatan->place }}
                                          <br>
                                          {{ Carbon\Carbon::parse($kegiatan->date)->format('d-m-Y') }}</p>
                                      </div>
                                  </div>
                                  <div class="modal-footer">
                                      <button type="button" class="btn btn-white">Bergabung</button>
      ...
      <div class="modal fade" id="modal-rutin" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
          <div class="modal-content bg-gradient-default">
            ...
            <div class="py-3 text-center">
            <form method="post" action="/kegiatan/rutin" enctype="multipart/form-data">
            {{ csrf_field() }}
