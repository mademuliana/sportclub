            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <form action="/inventaris/list-inventaris/search" method="GET">
                    <input type="text" name="cari" placeholder="Cari inventaris.." value="{{ old('cari') }}">
                    <input type="submit" value="CARI">
                    <a href="/inventaris/form-input-inventaris" class="btn btn-sm btn-success">Tambah</a>
                  </form>
                </div>
              </div>
            </div>
                ...
                <?php 
                  ...
                  ?>
                    ...
                    @foreach($sportclubs as $sportclub)
                      @if($sportclub->id == $inventaris->id_club)
                        {{$sportclub->name}}
                      @endif
                    @endforeach 
                    </td>
                    ...
                    <td>
                      ...
                      <a href="/inventaris/{{$inventaris->id}}" class="btn btn-sm btn-primary my-1">Edit</a>
                    </td>
                  </tr>
                  @endif
                  @endforeach
