      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Form Edit Data User</h1>
            <p class="text-white mt-0 mb-5">ubah data yang dibutuhkan dalam form registrasi ini </p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
          <div class="card card-profile shadow">                        
            <div class="card-body pt-0 pt-md-4">            
              <form method="post" action="/anggota/{{$users->id}}">              
            </div>
          </div>
        </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group" {{ $errors->has('name') ? 'has-error' : '' }}>
                        ...
                        <input name="name" type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="Nama Lengkap" value=" {{ $users->name }}">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group" {{ $errors->has('unit') ? 'has-error' : '' }}> 
                        ...
                        <input name="unit" type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" value=" {{ $users->unit }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group" {{ $errors->has('nip') ? 'has-error' : '' }}>
                        ...
                        <input name="nip" type="number" id="input-email" class="form-control form-control-alternative" value="{{$users->nip}}">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group" {{ $errors->has('email') ? 'has-error' : '' }}>
                        ...
                        <input name="email" type="email" id="input-username" class="form-control form-control-alternative" placeholder="sport@company.com" value=" {{ $users->email }}">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" {{ $errors->has('address') ? 'has-error' : '' }}>
                        ...
                        <input name="address" id="input-address" class="form-control form-control-alternative" placeholder="Alamat Rumah"  type="text" value=" {{ $users->address }} ">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group" {{ $errors->has('personal_contact') ? 'has-error' : '' }}>
                        ...
                        <input name="personal_contact" type="text" id="input-email" class="form-control form-control-alternative" value="{{$users->personal_contact}} ">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group" {{ $errors->has('place_of_birth') ? 'has-error' : '' }}>
                        ...
                        <input name="place_of_birth" type="text" id="input-country" class="form-control form-control-alternative" placeholder="tempat" value=" {{ $users->place_of_birth }} ">
